        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="mt-3 text-sm text-gray-500 dark:text-gray-400 max-w-xs">
              Discover and book amazing events near you. From conferences to concerts, find your next experience.
            </p>
          </div>
            ...
            <div className="mt-6 flex items-center gap-3">
              {['twitter', 'github', 'linkedin'].map((platform) => (
                <a
                  key={platform}
                  href="#"
                  className="w-9 h-9 rounded-lg bg-gray-100 dark:bg-gray-800 flex items-center justify-center text-gray-400 hover:text-primary-600 dark:hover:text-primary-400 hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors"
                  aria-label={platform}
                >
